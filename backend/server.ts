...
// A diferencia de FISH_API_KEY, esta es opcional: si no está, el endpoint de
// abajo responde "no disponible" y el frontend simplemente no muestra el
// botón de "Mejorar con IA" (ver GET /api/enhance-text/status). DeepSeek
// expone una API compatible con la de OpenAI, así que basta con apuntar el
// SDK oficial de OpenAI a su baseURL.
const deepSeekApiKey = process.env.DEEPSEEK_API_KEY
const deepSeek = deepSeekApiKey ? new OpenAI({ apiKey: deepSeekApiKey, baseURL: 'https://api.deepseek.com' }) : null
...
app.get('/api/enhance-text/status', (_req, res) => {
